...
public class DiskController {
    ...
    public static int solution(int[][] jobs) {
        ...
        Arrays.sort(jobs, (o1, o2) -> o1[0] - o2[0]); // 허용안해주는 에디터 및 jdk 버전이 존재함

        // 처리 시간 오름차순으로 정렬되는 우선순위 큐(Heap)
        PriorityQueue<int[]> pq = new PriorityQueue<>((o1, o2) -> o1[1] - o2[1]); // 허용안해주는 에디터 및 jdk 버전이 존재
        // jdk 17에서는 람다식 없이도 허용해줌
